  ...
  defaults: {
    languages: [
      ...
      },
      {
        ...
        Follow: "Obserwuj",
        Feed: "Aktualności",
        FeedPlaceholder: "Aktualności ze wszystkich stron które obserwujesz",
        Unfollow: "Nie obserwuj",
        About: "Opis",
        NoDescriptionAdded: "Nie dodano opisu",
        CoverPhoto: "Zdjęcie z okładki",
        AboutEmpty: "Opis jest pusty",
        ...
        Guid: "OpenBazaar ID (GUID)",
        Welcome: "Witaj",
        CreateStore: "Zostań sprzedawcą",
        GoToMyPage: "Moja strona",
        SearchForItemsPlaceholder: "Szukaj po nazwie lub słowie kluczowym",
        SearchForPagesPlaceholder: "Szukaj po nazwie lub słowie kluczowym",
        SearchFeedPlaceholder: "Szukaj po nazwie lub ID użytkownika",
        SearchForFollowersPlaceholder: "Szukaj po nazwie lub ID użytkownika",
        SearchForUsersPlaceholder: "Szukaj po nazwie lub ID użytkownika",
        EstDeliveryDomesticPlaceholder: "3-5 Dni Roboczych",
        EstDeliveryInternationalPlaceholder: "7-15 Dni Roboczych",
        OrderProcessingTimePlaceholder: "1-2 Dni Roboczych",
        TermsAndConditionsPlaceholder: "Wprowadź zasady i warunki...",
        TitlePlaceholder: "Wprowadź tytuł",
        DescriptionPlaceholder: "Wprowadź opis",
        ReturnPolicyPlaceholder: "Wprowadź politykę zwrotów...",
        CategoryPlaceholder: "Wprowadź kategorie",
        CategoryHelperText: "Kategorię służą do grupowania oraz organizacji przedmiotów w Twoim sklepie.",
        KeywordsHelperText: "Ustawianie słów kluczowych pomaga odnaleźć twoje produkty na rynku.",
        ExpirationDateHelperText: "Ustaw datę w której automatycznie przedmiot zostanie wycofany z twojego sklepu.",
        ClearExpirationDate: "Wyczyść datę ważności",
        ...
        YourName: "Twoje imię",
        BitcoinReturnAddress: "adres Bitcoin",
        LocalCurrency: "Lokalna waluta",
        TimeZone: "Strefa Czasowa",
        ShipToName: "Imię",
        ShipToStreet: "Ulica",
        ShipToCity: "Miasto",
        ShipToState: "Wojewódźtwo",
        ...
        Free: "Za darmo",
        Category: "Kategoria",
        ProcessingTime: "Czas Procesowania",
        UploadPhotos: "Załaduj zdjęcia",
        DragOrUploadPhotos: "Złap i załaduj zdjęcia",
        ExpirationDate: "Wygasa",
        UploadCoverPhoto: "Załaduj zdjęcie okładki",
        ShortDescription: "Krótki Opis",
        UpTo140Characters: "Do 140 znakow",
        PrimaryColor: "Kolor Podstawowy",
        SecondaryColor: "Kolor Drugi",
        TextColor: "Kolor Tekstu",
        CoverPhotoButton: "Wybierz Zdjęcie Okładki",
        AboutPlaceholder: "Pełny opis",
        BackgroundColor: "Kolor Tła",
        NotificationFollow: "od teraz Cie obserwuje",
        NoNotifications: "Brak powiadomień",
        WelcomeToYourPage: "Witaj na twojej stronie!",
        SearchForCategory: "Szukaj kategorii",
        Moderators: "Moderatorzy",
        CurrentModerators: "Obecni Moderatorzy",
        AddModerators: "Dodaj Nowego Moderatora",
        ...
        AllListings: "Wszystkie listy",
        ComingSoon: "Już Wkrótce",
        PaymentPending: "Płatność oczekująca",
        FinalizePurchase: "Finalizuj Zakup",
        LoadingImage: "Ładowanie Obrazu...",
        UploadAvatar: "Załaduj Avatar",
        SaveAvatar: "Zapisz Avatar",
        NewAvatar: "Wybierz nowy Avatar",
        NewCoverImage: "Wybierz Nowy Obraz na Okładkę",
        errorMessages: {
          saveError: "Dane nie mogły być zapisane.",
          getError: "Dane nie mogły być odzyskane.",
          missingError: "Niektóre pola są puste, lub błędnie wypełnione.",
          serverError: "Błędna odpowiedź z serwera.",
          userError: "Informację na temat tego ID nie zostały odnalezione",
          userNotFoundError: "Informację na temat tej osoby są niedostępne. Użytkownik może być offline.",
          notFoundError: "Dane nie mogły być załadowane dla:",
          socketError: "URL i WebSocket zawiodły. Łączenie do socket z domyślnym adresem ws://localhost:18466",
          contractError: "Ten przedmiot nie może zostać zakupiony",
          sellerError: "Serwer sprzedawcy odrzucił zapytanie zakupowe"
        },
        saveMessages: {
          Saved: "Zapisano",
          SaveSuccess: "Twoje zmiany zostały zapisane."
        },
        filters: {
          pagesAllTypes: "Wszystkie rodzaje",
          pagesStores: "Sklepy",
          pagesMods: "Usługi Moderatorów",
          pagesBasic: "Użytkownicy Podstawowi",
          listingsCurated: "Ze sklapór które obserwuję",
          listingsAll: "Ze wszystkich sklepów"
        },
        nav: {
          searchPlaceholder: "Wprowadź nazwę lub wyszukanie",
          myPage: "Moja Strona",
          customizePage:"Personalizacja Strony",
          sellItem:"Nowy",
          createListing:"Nowa lista",
          purchases:"Zakupy",
          sales:"Sprzedaż",
          cases:"Sprawy",
          ...
          settings:"Opcje",
          about:"O OpenBazaar",
          support:"Pomóż OpenBazaar"
        },
        onboarding: {
          intro: "Konfiguracja OpenBazaar",
          theme: "Wybierz Szablon dla Twojej Strony",
          chooseLanguage: "Wybierz Twój Język",
          contributors: "%{smart_count} Kontrybutor |||| %{smart_count} Kontrybutorzy",
          configure: "Konfiguruj swoje doświadczenie",
          disclaimer_title: "Klauzula zrzeczenia się odpowiedzialności",
          disclaimer_body: "OpenBazaar jest siecią handlu towarami i usługami bezpośrednio między ludźmi - za pomocą Bitcoina - bez centralnej organizacji kontrolującej platformę. To znaczy, że to Ty jesteś odpowiedzialny za Twoją działalność w tej sieci.<br /><br />Użytkownicy OpenBazaar nie są z założenia anonimowi. Większość komunikacji pomiędzy stronami jest zaszyfrowana, ale adresy IP są publiczne i mogą być przypisane do aktywności w sieci. Strony działające na szkodę innych mogą użyć tych informacji przeciwko Tobie; ochrona Twojej prywatności to Twoja odpowiedzialność.<br /><br />Użytkownicy OpenBazaar muszą podlegać lokalnemu prawu pod którym się znajdują oraz ich własnemu sumieniu. Deweloperzy OpenBazaar nie popierają - oraz nie ponoszą odpowiedzialności za - jakiekolwiek nielegalne działanie na platformie.<br /><br />Społeczność deweloperów OpenBazaar ciężko pracowała aby dostarczyć darmową platformę handlu dla świata. Ale tak jak z każdym oprogramowaniem, błędy będą się pojawiać. Deweloperzy nie są odpowiedzialni jakąkolwiek utratę pieniędzy lub problemy z oprogramowaniem.<br /><br />Używając z OpenBazaar jesteś odpowiedzialny za swoje działania w sieci OpenBazaar.",
          yourCountry: "Wybierz Twój Kraj",
          localCurrency: "Wybierz Twoją Walutę",
          LanguagePlaceholder: "Szukaj języka",
          CountryPlaceholder: "Szukaj kraju",
          CurrencyPlaceholder: "Szukaj waluty",
          TimezonePlaceholder: "Szukaj strefy czasowej",
          ShortDescriptionPlaceholder: "Powiedź coś interesującego... (max. 160 znaków)",
          timeZone: "Wybierz swoją strefę czasową",
          yourDetails: "Ustaw swoje informacje",
          handle: "Nazwa użytkownika",
          knownAs: "Obecnie jesteś znany jako:",
          wouldYou: "Czy chciałbyś się zarejestrować łatwą do zapamiętania nazwą użytkownika?",
          registerNew: "Zarejestruj Nowy",
          recommended: "Rekomendowane strony do obserwowania",
          connectExisting: "Połączenie Istnieje",
          avatar: "Ustaw Avatar",
          chooseAvatar: "Wybierz Avatar"
        },
        buyFlow: {
          MustAddAddress: "Musisz dodać adres do wysyłki",
          VendorShipsTo: "Ten sprzedawca wysyła do tych krajów"
        }
      },
      {
        langName: "German",
